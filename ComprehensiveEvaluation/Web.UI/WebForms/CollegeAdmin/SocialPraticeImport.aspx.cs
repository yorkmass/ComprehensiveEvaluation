...
public partial class WebForms_CollegeAdmin_SocialPraticeImport : System.Web.UI.Page
{
    ...
    protected void mnuMain_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
    {
        ...
        {
            case "Export":
                DSSocialPratice.SocialPraticeDataTable table = new DSSocialPratice.SocialPraticeDataTable();
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ExportExcel.ImportSocialPraticeExcelFile(destPhysicalFile);
    ...
    protected void sdsSocialPratice_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
    {
