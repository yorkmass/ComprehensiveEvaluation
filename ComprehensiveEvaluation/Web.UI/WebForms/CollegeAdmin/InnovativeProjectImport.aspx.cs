...
public partial class WebForms_CollegeAdmin_InnovativeProjectImport : System.Web.UI.Page
{
    ...
    protected void mnuMain_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
    {
        ...
        {
            case "Export":
                DSInnovativeProject.InnovativeProjectGetDataTable table = new DSInnovativeProject.InnovativeProjectGetDataTable();
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ExportExcel.ImportInnovativeProjectExcelFile(destPhysicalFile);
